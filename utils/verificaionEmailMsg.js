function verificaionEmailMsg(verificationLink, name) {
  const message = `
    ...
    <body>
        <div class="container">
            <div class="header">
                <h1><strong>DemocracyHUB</strong></h1>
                <h2>Unlock the Power of DemocracyHUB!</h2>
            </div>
            <div class="content">
                <p>Hey ${name},</p>
                <p>You're one step away from unlocking the full potential of DemocracyHUB! We're building a community that's all about empowering citizens and shaping the future of democracy. And we want you to be a part of it!</p>
